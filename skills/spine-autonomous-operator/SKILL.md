...
For **backlog triage, GitHub issue prioritization, and SP packet creation from issues**, run [`skills/router-backlog-orchestrator/SKILL.md`](../router-backlog-orchestrator/SKILL.md) first, then continue here at Phase 2.
